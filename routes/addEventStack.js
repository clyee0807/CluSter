...
export default function AddEventStack() {
    return(
        <Stack.Navigator>
            ...
            <Stack.Screen name='Notification' component={Notice}options={{headerTitleAlign: 'center', headerShadowVisible: false,headerTitle: () => ( <Text style={styles.headerTitle}>Notificatios</Text>) }}></Stack.Screen>            <Stack.Screen name='AddEvent' component={AddEvent} options={{headerTitleAlign: 'center', headerShadowVisible: false,headerTitle: () => ( <Text style={styles.headerTitle}>Add Events</Text>) }}></Stack.Screen>
