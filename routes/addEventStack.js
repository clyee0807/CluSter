...
export default function AddEventStack() {
    return(
        <Stack.Navigator>
            ...
            <Stack.Screen name='Notification' component={Notice}options={{headerTitleAlign: 'center', headerShadowVisible: false,headerTitle: () => ( <Text style={styles.headerTitle}>Notifications</Text>) }}></Stack.Screen>            
